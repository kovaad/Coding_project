...
The table shows the descriptive statistics of Coca Cola and and Sport chocolate bar prices. As the result indicates both prices have higher mean than median. The range of prices is around 200 Huf for both products
...
# Distribution
As the focus of this data collection is the price of Coca Cola and price of Sport Chocolate bar, the Figures below shows the histograms for these variable.
...
coke_histogram <- ggplot( data = df ) +
  geom_histogram( aes( x = Price_cola ) , fill = "#464646", col= "#f40009", bins = 5 ) +
...
Sport chocolate bar have lower prices compared to Coca Cola, however there are many variations.An extreme value of 289 Huf and other prices are between 85 Huf and 159 Huf. We decided to put 8 number of bins in order to visualize the extreme value, and other prices. 

```{r, echo = FALSE, warning=FALSE, fig.width=4, fig.height = 3, fig.align="center" }

#hist(df$Price_sport, breaks= "FD") # To calculate breaks

sportbar_histogram <- ggplot( data = df ) +
  geom_histogram( aes( x = Price_sport ) , fill = "#00bc00", col= "#fdd803", bins = 8 ) +
